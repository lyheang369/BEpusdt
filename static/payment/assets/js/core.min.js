(function () {
    ...
    function generateQRCode() {
        ...
        const containerHeight = qrContainer.clientHeight || containerWidth;
        const measuredSize = Math.floor(Math.min(containerWidth, containerHeight) - 10);
        const qrSize = measuredSize > 0 ? measuredSize : 150;
    ...
    function showTimeoutMessage() {
        const t = window.i18next ? window.i18next.t.bind(window.i18next) : function (key) {
            const translations = {
                'payment.paymentTimeout': 'Payment Time Expired',
                'payment.timeoutMessage': 'Sorry, the payment time has expired.<br>Please start a new payment or contact customer support.',
                'payment.returnToMerchant': 'Return to Merchant'
            };
            return translations[key] || key;
        };
        ...
        modal.innerHTML = `
            <div style="margin-bottom: 20px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#e53e3e" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    function showWaitingConfirmation(data) {
        ...
        const t = window.i18next ? window.i18next.t.bind(window.i18next) : function (key) {
            const translations = {
                'payment.waitingConfirmation': 'Waiting for Network Confirmation',
                'payment.confirmationMessage': 'Payment request detected. Waiting for blockchain confirmation...',
                'payment.confirmationNote': 'Please wait. The system will automatically check the confirmation status.',
                'payment.estimatedTime': 'Estimated confirmation time: 1-3 minutes'
            };
            return translations[key] || key;
        };
        ...
        modal.innerHTML = `
            <div style="margin-bottom: 20px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#667eea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="animation: spin 2s linear infinite;">
            ...
            <div style="margin-top: 15px; padding-top: 12px; border-top: 1px solid #f0f0f0; font-size: 12px; color: #aaa;">
                Powered by <a href="https://github.com/v03413/BEpusdt" target="_blank" style="color: #667eea; text-decoration: none; font-weight: 600;">BEpusdt</a> · Github
            </div>
        `;
    ...
    function showSuccessMessage(data) {
        ...
        const t = window.i18next ? window.i18next.t.bind(window.i18next) : function (key) {
            const translations = {
                ...
                'payment.transactionHash': 'Your payment has been confirmed. Transaction hash:',
        ...
        modal.innerHTML = `
            <div style="margin-bottom: 20px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#48bb78" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
